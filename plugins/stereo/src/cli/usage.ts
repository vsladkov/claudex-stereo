export function printUsage(): void {
  console.log(
    [
      ...
      '  node scripts/codex-companion.ts plan-store --verdict <value> [--round <n>] [--reviewed-by <label>] [--summary <text>] [--findings-file <path>] [--open-question <text>]... [--residual-risk <text>]... [--json] < plan.md',
