export function printUsage(): void {
  console.log(
    [
      ...
      '  node scripts/codex-companion.ts adversarial-review [--wait|--background] [--base <ref>] [--scope <auto|working-tree|branch>] [--model <model-or-alias>] [--effort <none|minimal|low|medium|high|xhigh|max|ultra>] [focus text]',
      '  node scripts/codex-companion.ts task [--background] [--write] [--resume-last|--resume|--fresh|--thread <id>] [--model <model-or-alias>] [--effort <none|minimal|low|medium|high|xhigh|max|ultra>] [--output-schema <path>] [--prompt-file <path>] [prompt]',
      '  node scripts/codex-companion.ts plan-review [--background] [--thread <id>] [--round <n>] [--slot <name>] [--model <model-or-alias>] [--effort <none|minimal|low|medium|high|xhigh|max|ultra>] [--plan-file <path>] [plan text]',
      '  node scripts/codex-companion.ts plan-state [--list|--open|--clear|--mark-implemented|--compare <slotA> <slotB>] [--slot <name>] [--json]',
