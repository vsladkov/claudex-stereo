export function printUsage(): void {
  console.log(
    [
      ...
      '  node scripts/codex-companion.ts plan-state [--open|--clear|--mark-implemented] [--json]',
      ...
      '  node scripts/codex-companion.ts implement-state [--record|--update|--complete|--clear] [--state-file <path>] [--json]',
