export function printUsage(): void {
  console.log(
    [
      ...
      '  node scripts/codex-companion.ts task [--background] [--write] [--resume-last|--resume|--fresh|--thread <id>] [--model <model-or-alias>] [--effort <none|minimal|low|medium|high|xhigh|max>] [--prompt-file <path>] [prompt]',
      ...
      '  node scripts/codex-companion.ts plan-store --verdict <value> [--round <n>] [--reviewed-by <label>] [--summary <text>] [--open-question <text>]... [--residual-risk <text>]... [--json] < plan.md',
