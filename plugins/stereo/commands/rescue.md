...
argument-hint: '[--background|--wait] [--resume|--fresh] [--model <codex-model-or-alias>] [--effort <none|minimal|low|medium|high|xhigh|max|ultra>] [what Codex should investigate, solve, or continue]'
